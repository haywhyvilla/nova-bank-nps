...
<template>
  <Layout>
    ...
    <BRow>
      <BCol sm="6" xl="3" v-for="(item, index) in gridList" :key="index">
        <div class="card text-center">
          <BCardBody>
            <BDropdown class="float-end" variant="white" menu-class="dropdown-menu-end" right toggle-class="font-size-16 text-body p-0">

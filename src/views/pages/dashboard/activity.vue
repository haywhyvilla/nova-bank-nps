...
<template>
    <BCol xl="4">
        <BCard no-body>
            <BCardBody>
                <div class="float-end">
                    <BDropdown right toggle-class="p-0" variant="white" menu-class="dropdown-menu-end">
                        ...
                        <BDropdownItem href="#">Recent</BDropdownItem>
                        <BDropdownItem href="#">By Users</BDropdownItem>
                    </BDropdown>
                </div>

                <h4 class="card-title mb-4">Recent Activity</h4>

                <simplebar class="activity-feed mb-0 ps-2" data-simplebar style="max-height: 336px;">
                    <li class="feed-item">

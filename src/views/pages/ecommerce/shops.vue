...
<template>
  <Layout>
    ...
    <BRow rows="mb-2">
      <BCol md="6">
        <div class="mb-3">
          <BLink href="javascript:void(0);" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-plus me-2"></i>
            Add New</BLink>
        </div>
      </BCol>
              ...
              <div class="media-body flex-grow-1 align-self-center">
                <div class="border-bottom pb-1">
                  <h5 class="text-truncate font-size-16 mb-1">
                    <BLink href="#" class="text-dark">{{ item.name }}</BLink>
                  </h5>
                  <p class="text-muted">
    ...
    <BRow>
      <BCol cols="xl-12">
        <div class="text-center my-3">
          <BLink href="javascript:void(0);" class="text-primary"><i class="mdi mdi-loading mdi-spin font-size-20 align-middle me-2"></i>
            Load more
          </BLink>
        </div>
      </BCol>

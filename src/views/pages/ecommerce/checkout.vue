    ...
    <BRow>
      <BCol cols="8">
        <div class="custom-accordion">
          <BCard no-body>
            <BLink href="javascript: void(0);" class="text-dark" data-toggle="collapse" v-b-toggle.checkout-billinginfo-collapse>
              <div class="p-4">
          ...
          <BCard no-body>
            <BLink href="javascript: void(0);" class="collapsed text-dark" data-toggle="collapse" v-b-toggle.checkout-shippinginfo-collapse>
              <div class="p-4">
                <div class="media d-flex align-items-center">
                  <div class="me-3">
                ...
                <BRow>
                  <BCol lg="4" sm="6">
                    <div class="card border rounded active shipping-address">
                      <BCardBody>
                        <BLink href="#" class="float-end ms-1" data-toggle="tooltip" data-placement="top" title="Edit">
          ...
          <BCard no-body>
            <BLink href="javascript: void(0);" class="collapsed text-dark" data-toggle="collapse" v-b-toggle.checkout-paymentinfo-collapse>
              <div class="p-4">
                <div class="media d-flex align-items-center">
                  <div class="me-3">

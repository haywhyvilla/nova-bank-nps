              ...
              <BRow>
                <BCol md="6">
                  <div class="mb-3">
                    ...
                    <input id="validationCustom01" v-model="form.fname" type="text" class="form-control" placeholder="First name" :class="{
                ...
                <BCol md="6">
                  <div class="mb-3">
                    ...
                    <input id="validationCustom02" v-model="form.lname" type="text" class="form-control" placeholder="Last name" :class="{
                ...
                <BCol lg="12">
                  <div class="mb-3">
                    <div class="custom-control custom-checkbox">
                      <input id="invalidCheck" type="checkbox" class="custom-control-input" :class="{
                        'is-invalid': submitted && v$.form.confirm.$error,
                        'is-valid': submitted && !v$.form.confirm.$error
                      }" />
                      <label class="custom-control-label ms-2" for="invalidCheck">Agree to terms and conditions</label>
                      <div v-if="submitted && v$.form.confirm.$error" class="invalid-feedback">
                        <span v-if="!!v$.form.confirm.required">You must agree before submitting.</span>
                      </div>
                      <div v-else class="valid-feedback">It looks good</div>
                    </div>
                  </div>
              ...
              <BRow>
                <BCol md="4">
                  <div class="mb-3 position-relative">
                    ...
                    <input id="validationTooltip01" v-model="tooltipform.fname" type="text" class="form-control" placeholder="First name" :class="{
                ...
                <BCol md="4">
                  <div class="mb-3 position-relative">
                    ...
                    <input id="validationTooltip02" v-model="tooltipform.lname" type="text" class="form-control" placeholder="Last name" :class="{
            ...
            <BForm action="#" @submit.prevent="typeForm">
              ...
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="typesubmit && v$.typeform.password.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.typeform.password.minLength">Password must be at least 6 characters.</span>
                  </div>
                </div>
                <div class="mt-2">
              ...
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="typesubmit && v$.typeform.email.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.typeform.email.email">This value should be a valid email.</span>
                  </div>
                </div>
              </div>
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="typesubmit && v$.typeform.url.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.typeform.url.url">This value should be a valid url.</span>
                  </div>
                </div>
              </div>
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="typesubmit && v$.typeform.digit.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.typeform.digit.numeric">This value should be digits.</span>
                  </div>
                </div>
              </div>
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="typesubmit && v$.typeform.number.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.typeform.number.numeric">This value should be a valid number.</span>
                  </div>
                </div>
              </div>
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="typesubmit && v$.typeform.alphanum.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.typeform.alphanum.alphaNum">This value should be alphanumeric.</span>
                  </div>
                </div>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3 mb-0">
                <div>
                  ...
                  <BButton type="reset" variant="secondary m-l-5 ml-1">
                    Cancel
                  </BButton>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="submit && v$.range.minlen.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.range.minlen.minLength">This value is too short. It should have 6 characters or
                      more.</span>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="submit && v$.range.between.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.range.between.maxLength">This value length is invalid. It should be between 5
                      and
                      10 characters long.</span>
                    <span v-else-if="!!v$.range.between.minLength">This value length is invalid. It should be between 5
                      and
                      10 characters long.</span>
                  </div>
                </div>
              ...
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div v-if="submit && v$.range.rangeval.$error" class="invalid-feedback">
                    ...
                    <span v-else-if="!!v$.range.rangeval.minValue">This value should be between 6 and 100.</span>
                    <span v-else-if="!!v$.range.rangeval.maxValue">This value should be between 6 and 100.</span>
                  </div>
                </div>
              </div>
              <div class="mb-3">

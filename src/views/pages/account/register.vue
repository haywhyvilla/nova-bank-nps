              ...
              <BCardBody class="p-4">
                ...
                <div class="p-2 mt-4">
                  ...
                  <BForm @submit.prevent="tryToRegisterIn">
                    ...
                    <BFormGroup id="email-group" label="Username" class="mb-3" label-for="username">
                    ...
                    <BFormGroup id="password-group" label="Password" class="mb-3" label-for="password">
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="auth-terms-condition-check">I accept
                        <BLink href="javascript: void(0);" class="text-dark">Terms and Conditions</BLink>
                      </label>
                    </div>
                    <div class="mt-3 text-end">
                      <BButton type="submit" variant="primary" class="w-sm">Register</BButton>
                    </div>

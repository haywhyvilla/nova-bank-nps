        ...
        <BCard no-body>
          <BCardBody>
            ...
            <h1 class="mb-3">
              ...
              <small class="text-muted fw-normal">Semibold 2.25rem (36px)</small>
            </h1>
            <h2 class="mb-3">
              h2. Bootstrap heading
              <small class="text-muted fw-normal">Semibold 1.8rem (28.8px)</small>
            </h2>
            <h3 class="mb-3">
              h3. Bootstrap heading
              <small class="text-muted fw-normal">Semibold 1.575rem (25.2px)</small>
            </h3>
            <h4 class="mb-3">
              h4. Bootstrap heading
              <small class="text-muted fw-normal">Semibold 1.35rem (21.6px)</small>
            </h4>
            <h5 class="mb-3">
              h5. Bootstrap heading
              <small class="text-muted fw-normal">Semibold 1.125rem (18px)</small>
            </h5>
            <h6 class="mb-3">
              h6. Bootstrap heading
              <small class="text-muted fw-normal">Semibold 0.9rem (14.4px)</small>
            </h6>
          </BCardBody>
        </BCard>
      </BCol>

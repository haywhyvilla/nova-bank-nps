          ...
          <BCardBody>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <BButton type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
                    </BButton>
                  </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <BButton type="button" variant="light" data-dismiss="modal">
                      Close
                    </BButton>
                  </div>
                </div>
            ...
            <BRow class="d-flex">
              <BCol lg="6" cols="mt-4">
                ...
                <BButton type="button" variant="primary" v-b-modal.modal-standard>
                  Standard modal
                </BButton>
              ...
              <BCol lg="6" cols="mt-4">
                ...
                <div class="button-items">
                  <!-- Extra Large modal -->
                  <BButton variant="primary" type="button" class="waves-effect waves-light me-2" v-b-modal.modal-xl>
                    Extra large modal
                  </BButton>
                  ...
                  <!-- Large modal -->
                  <BButton variant="success " type="button" class="waves-effect waves-light me-2" v-b-modal.modal-lg>
                    Large modal
                  </BButton>
                  ...
                  <!-- Small modal -->
                  <BButton variant="danger" type="button" class="waves-effect waves-light" v-b-modal.modal-sm>
                    Small modal
                  </BButton>
            ...
            <div class="mt-4">
              <BRow>
                <BCol md="6" xl="4">
                  <div class="mt-4">
                    <BCardTitle>Vertically centered</BCardTitle>
                    <p class="card-title-desc">
                      Add <code>.modal-dialog-centered</code> to
                      <code>.modal-dialog</code> to vertically center the modal.
                    </p>
                  </div>
                  <BButton variant="primary" type="button" v-b-modal.modal-center class="waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-center">
                    Center modal
                  </BButton>
                ...
                <BCol md="6" xl="4">
                  <div class="mt-4">
                    <BCardTitle>Scrollable modal</BCardTitle>
                    <p class="card-title-desc">
                    ...
                    <BButton variant="primary" type="button" v-b-modal.modal-scrollable class="waves-effect waves-light" data-toggle="modal" data-target="#exampleModalScrollable">
                      Scrollable modal
                    </BButton>

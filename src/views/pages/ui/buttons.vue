      ...
      <BCol xl="12">
        <BCard no-body>
          <BCardBody>
            ...
            <div class="button-items d-flex flex-wrap gap-3">
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="button-items d-flex flex-wrap gap-2">
              ...
              <BButton pill variant="link">Link</BButton>
      ...
      <BCol xl="6">
        <BCard no-body>
          <BCardBody>
            ...
            <div class="button-items d-flex flex-wrap gap-2">
              <BButton variant="primary" class="btn-soft-primary">Primary</BButton>
              <BButton variant="success" class="btn-soft-success">Success</BButton>
              <BButton variant="info" class="btn-soft-info">Info</BButton>
              <BButton variant="warning" class="btn-soft-warning">Warning</BButton>
              <BButton variant="danger" class="btn-soft-danger">Danger</BButton>
              <BButton variant="dark" class="btn-soft-dark">Dark</BButton>
              <BButton variant="secondary" class="btn-soft-secondary">Secondary</BButton>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <div class="button-items d-flex flex-wrap gap-2 align-items-center">
              <BButton size="lg" variant="primary">Large button</BButton>
              <BButton size="lg" variant="light">Large button</BButton>
              <BButton size="sm" variant="primary">Small button</BButton>
              <BButton size="sm" variant="light">Small button</BButton>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="button-items d-flex flex-wrap gap-2">
              ...
              <BButton variant="danger" class="w-sm ms-1">Small</BButton>
              <BButton variant="warning" class="w-md ms-1">Medium</BButton>
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="button-items">
              <BButton variant="primary" type="button" data-toggle="button" aria-pressed="false">
                Single toggle
              </BButton>
            </div>
          </BCardBody>
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="d-grid gap-2">
              ...
              <BButton block variant="light" size="sm">Block Level Button</BButton>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <BRow>
              <BCol xl="6">
                <BFormCheckboxGroup class="custom-check" v-model="selectedCheck" button-variant="primary" :options="optionsCheck" name="buttons-1" buttons></BFormCheckboxGroup>
              </BCol>
              <BCol xl="6">
                <BFormRadioGroup class="custom-check" id="btn-radios-1" button-variant="light" v-model="selected" :options="options" buttons name="radios-btn-default"></BFormRadioGroup>
              </BCol>
            </BRow>
          </BCardBody>
        </BCard>
          ...
          <BCardBody>
            ...
            <div class="d-flex flex-wrap gap-3 align-items-center">
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                <BButton type="button" variant="danger">Left</BButton>
                <BButton type="button" variant="danger">Middle</BButton>
                <BButton type="button" variant="danger">Right</BButton>
              </div>
            </div>

            <div class="d-flex flex-wrap gap-3 align-items-center mt-3">
              <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
                <BButton type="button" variant="outline-primary">
                  Left
                </BButton>
                <BButton type="button" variant="outline-primary">
                  Middle
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                <BButton type="button" variant="outline-danger">
                  Left
                </BButton>
                <BButton type="button" variant="outline-danger">
                  Middle

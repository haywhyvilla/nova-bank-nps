...
export default {
  ...
  methods: {
    ...
    chain() {
      ...
      // Retrieve progress steps from the running instance
      const progressSteps = Toast.getProgressSteps();

      if (progressSteps) {
        Swal.fire({
          title: 'Progress Steps',
          html: `The current progress steps are: <pre>${JSON.stringify(progressSteps)}</pre>`,
          icon: 'info',
        });
      } else {
        Toast.fire('No Progress Steps', 'No progress steps are set.', 'info');
      }
            ...
            <BRow class="text-center">
              ...
              <BCol lg="4" sm="6" cols="xl-3 mb-2">
                <div class="p-3">
                  ...
                  <BButton type="button" variant="primary" @click="customBackground">
                    Click me
                  </BButton>
                </div>
              </BCol>
              ...
              <BCol lg="4" sm="6" cols="xl-3 mb-2">
                <div class="p-3">
                  ...
                  <BButton type="button" variant="primary" @click="chain">
                    Click me
                  </BButton>
                </div>
              </BCol>

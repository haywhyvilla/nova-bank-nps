        ...
        onRoutechange() {
            setTimeout(() => {
                if (document.getElementsByClassName("mm-active").length > 0) {
                    ...
                    if (currentPosition > 500 && this.$refs.currentMenu && this.$refs.currentMenu.SimpleBar)
...
<template>
    ...
    <div class="vertical-menu">
        ...
        <button type="button" @click="toggleMenu" class="btn btn-sm px-3 font-size-16 header-item waves-effect vertical-menu-btn">
